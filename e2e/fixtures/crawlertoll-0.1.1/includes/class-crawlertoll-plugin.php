...
class CrawlerToll_Plugin {
	...
	public function register_rest_routes() {
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				// Intentionally public: this serves /.well-known/context-license.json,
				// a machine-readable discovery document (like robots.txt) that AI
				// crawlers fetch unauthenticated. It returns only intentionally-public
				// site metadata (name, domain, pricing, terms URL) — no private data.
